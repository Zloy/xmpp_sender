...
If you've received that message, then launch rtorrent ang go to <tt>Options/Preferences/Advanced/Run Program</tt> tab
...
see in LICENSE[http://github.com/Zloy/xmpp_sender/blob/master/LICENSE]
